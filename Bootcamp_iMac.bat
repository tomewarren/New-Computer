...
## Concat Boxstarter files to a local file
  ...
  "https://raw.githubusercontent.com/iRobie/New-Computer/master/src/Personal-WHSFront.txt",
  "https://raw.githubusercontent.com/iRobie/New-Computer/master/src/Personal-Bootcamp-iMac.txt"
  )
